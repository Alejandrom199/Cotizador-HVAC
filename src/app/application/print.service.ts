      ...
      <div class="print-container">
        ...
        <header class="doc-header">
          <div class="brand-section">
            ...
            <div class="brand-contact">RUC: 1792182749001 | Quito, Ecuador | info@emasesor.com</div>
          </div>
      ...
      <div class="print-container">
        ...
        <header class="doc-header">
          <div class="brand-section">
            ...
            <div class="brand-tagline">Climatización &amp; Ventilación Mecánica — Ecuador</div>
            <div class="brand-contact">RUC: 1792182749001 | PBX: (02) 299-0000 | Quito, Ecuador</div>
          </div>
          <div class="doc-badge-section">
...
<head>
  ...
  <style>
    ...
    *, *::before, *::after {
    ...
    /* REGLAS PROFESIONALES DE IMPRESIÓN */
    @page {
    ...
    @media print {
      ...
      tr, .data-table, .financial-block, .totals-card, .signatures-section, .meta-card, .executive-summary, .content-box {
        page-break-inside: avoid !important;
        break-inside: avoid !important;
      }

      .category-header-row, .category-subtotal-row {
        page-break-inside: avoid !important;
        break-inside: avoid !important;
      }
    }
